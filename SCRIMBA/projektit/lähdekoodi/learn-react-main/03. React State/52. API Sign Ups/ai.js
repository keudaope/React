...
not to include too many extra ingredients. Format you response in markdown to make it easier to render to a web page
`;
const hf = new HFInference({ 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 });
